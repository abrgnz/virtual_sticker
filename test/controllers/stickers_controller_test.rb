...
class StickersControllerTest < ActionController::TestCase
  ...
  test "should create sticker" do
    assert_difference('Sticker.count') do
      post :create, sticker: { album_id: @sticker.album_id, description: @sticker.description, image: @sticker.image, number: @sticker.number, title: @sticker.title }
    end
  ...
  test "should update sticker" do
    patch :update, id: @sticker, sticker: { album_id: @sticker.album_id, description: @sticker.description, image: @sticker.image, number: @sticker.number, title: @sticker.title }
    assert_redirected_to sticker_path(assigns(:sticker))
  end
